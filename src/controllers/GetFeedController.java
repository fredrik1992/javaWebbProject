...
public class GetFeedController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // have to go to sql connection and call funciton to get alot of feed beans in a list that is returned here
		//go trough them all and send them back to Feed where we can do somthing with it
	}
